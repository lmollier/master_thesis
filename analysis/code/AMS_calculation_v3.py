...
def AMS_calculation_v3(tag, rebining):
    ...
    output_file = 'ams_v3_output_'+tag+"rebin_"+str(rebining)+'.root'
    ...
    name_txt_file_output  = 'ams_v3_output_'+tag+"rebin_"+str(rebining)+'.txt'
    ...
    name_txt_file_output_for_run  = 'best_ams_v3_'+tag+"rebin_"+str(rebining)+'.txt'
    ...
    name_txt_file_output_second_for_run  = 'second_best_ams_v3_'+tag+"rebin_"+str(rebining)+'.txt'
    ...
    name_txt_file_output_third_for_run  = 'third_best_ams_v3_'+tag+"rebin_"+str(rebining)+'.txt'
    ...
    name_txt_file_output_fourth_for_run  = 'fourth_best_ams_v3_'+tag+"rebin_"+str(rebining)+'.txt'
