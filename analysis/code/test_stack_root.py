...
#cols_stack = [kBlue,kOrange,kTeal, kPink,kSpring,kViolet]
cols_stack = [kBlue-9,kMagenta-10,kRed-6, kOrange-2,kPink-9,kViolet]
    ...
    try:
        ...
        for h in list_histos:
            ...
            if(iter_color<6):
                ...
                h.SetFillColor(11+iter_color-6)
                h.SetLineColor(11+iter_color-6)  
            iter_color+=1
